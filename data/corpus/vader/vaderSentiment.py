...
def sentiment(text):
    ...
    wordsAndEmoticons = str(
        text).split()  # doesn't separate words from adjacent punctuation (keeps emoticons & contractions)
    ...
    for item in wordsAndEmoticons:
        ...
        if item_lowercase in word_valence_dict:
            ...
            if i > 2 and str(wordsAndEmoticons[i - 3]).lower() not in word_valence_dict:
                ...
                twoonezero = "{} {}".format(str(wordsAndEmoticons[i - 2]), str(wordsAndEmoticons[i - 1]),
                                            str(wordsAndEmoticons[i]))
                twoone = "{} {}".format(str(wordsAndEmoticons[i - 2]), str(wordsAndEmoticons[i - 1]))
                threetwoone = "{} {} {}".format(str(wordsAndEmoticons[i - 3]), str(wordsAndEmoticons[i - 2]),
                ...
                if len(wordsAndEmoticons) - 1 > i + 1:
                    zeroonetwo = "{} {}".format(str(wordsAndEmoticons[i]), str(wordsAndEmoticons[i + 1]),
